...
class SkyWarsCommand extends Command {
    ...
    {
        parent::__construct("sw");
        $this->description = "SkyWars commands";
        $this->usageMessage = "/sw <help>";
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        ...
        switch ($args[0]) {
            case "help":
                ...
                break;
            case "settops":
                $this->plugin->addTops($sender->getX(), $sender->getY(), $sender->getZ(), $sender->getLevel(), $sender);
                break;
            case "create":
                if(!isset($args[1])) {
